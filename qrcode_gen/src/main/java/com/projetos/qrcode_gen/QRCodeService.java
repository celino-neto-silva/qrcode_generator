...
public class QRCodeService {
    private static final String QR_CODE_DIR = "C:/qrcodes";
    ...
    public String generateQRCode(String text) {
        try {
            ...
            throw new RuntimeException("Problem in to generate the QRCode", e);
        }
    }
}
 */
...
public class QRCodeService {
    ...
    // Diretório dentro da pasta do usuário (cross-platform)
